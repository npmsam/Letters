...
Server messages shouldn't be hard to change, they're just [Letters](https://github.com/npmsam/Letters) on the screen
anyway 😉.
...
You can download a ready to use JAR file from the [GitHub releases](https://github.com/npmsam/Letters/releases) page or
